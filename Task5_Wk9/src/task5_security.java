...
public class task5_security extends Thread {
	...
	//create a method to get the next thread id by incrementing the thread number variable by 1
	  ...
	  public static void main (String args [])
	  {
	    ...
	    {  
	      ...
	      try
	    	  {
	    		  String filename = "jdbc:mysql://ecommsvr5:3306/?verifyServerCertificate=false&useSSL=true&requireSSL=true";
	    		  String databaseTable = "anthonyw_oop";
				                                             
	    		  String userName = "anthonyw_aoop";
	    		  String password = "1716208";
	          
	    		  String databaseConn = databaseTable + userName;
	          
	    		  s_conn = DriverManager.getConnection(filename,databaseConn,password);
	      ...
	      {
	          threadList[i] = new task5_security();
	          threadList[i].start();
	      }
